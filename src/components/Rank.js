    ...
    if (team === 'char') {
      ...
      return (
        ...
        <Stage width={1076} height={2100}>
          ...
          />
          {deck.map((value, index) => {
            return <TeamSet stat={value} setX={50} setY={deck.indexOf(value)} isDuo={true} key={index}/>
          })}
          </Layer>
        </Stage>
      </div>
      ...
      return (
        ...
        <Stage width={1076} height={2100}>
          ...
          />
          {deck.map((value, index) => {
            return <TeamSet stat={value} setX={50} setY={deck.indexOf(value)} isDuo={false} key={index}/>
          })}
          </Layer>
        </Stage>
      </div>
