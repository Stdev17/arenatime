...
var getCount_1 = require("./getCount");
    ...
    describe('query comments', function () {
        it('should succeed', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getCount_1["default"]({}, {}, ['match-table'])];
                    case 1:
                        res = _a.sent();
                        count = JSON.parse(res.body).message;
        ...
        it('should fail', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getCount_1["default"]({}, {}, ['match-tabl'])];
                    case 1:
                        res = _a.sent();
