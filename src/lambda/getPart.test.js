...
describe('getPart', function () {
    describe('get part from athena', function () {
        it('should succeed', function () { return __awaiter(void 0, void 0, void 0, function () {
            var res, count;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getPart_1["default"](ev1, {}, ['match-table'])];
                    case 1:
                        res = _a.sent();
        ...
        it('should fail', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getPart_1["default"](ev1, {}, ['princonne-arenatime'])];
                    case 1:
                        res = _a.sent();
                        count = JSON.parse(res.statusCode);
        ...
        it('should fail', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getPart_1["default"](ev2, {}, ['match-table'])];
                    case 1:
                        res = _a.sent();
                        count = JSON.parse(res.statusCode);
                        expect(count).to.equal(400);
